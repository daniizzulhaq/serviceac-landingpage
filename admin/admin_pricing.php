...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] == 0) {
        ...
        if ($upload['success']) {
            ...
            // Insert pricing
            $sql = "INSERT INTO pricing (nama_paket, badge, harga, gambar, is_featured, urutan) 
                    VALUES ('$nama_paket', '$badge', '$harga', '$gambar', $is_featured, $urutan)";
            
            if ($conn->query($sql)) {
                $pricing_id = $conn->insert_id;
                    ...
                    foreach ($_POST['fitur_nama'] as $index => $fitur) {
                        if (!empty($fitur)) {
                            ...
                            $sql_fitur = "INSERT INTO pricing_features (pricing_id, nama_fitur, is_available, urutan) 
                                         VALUES ($pricing_id, '$fitur_nama', $fitur_available, $fitur_urutan)";
                ...
                $error = 'Gagal menambahkan paket: ' . $conn->error;
            }
        } else {
            $error = $upload['message'];
        }
    } else {
        $error = 'Silakan upload gambar paket!';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Kelola Pricing - Admin</title>
        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar p-4">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="admin_pricing.php">
            ...
            <div class="col-md-10 main-content">
                <h2 class="mb-4">Tambah Paket Pricing</h2>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="badge" placeholder="Basic, Popular, Complete" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="harga" placeholder="75K, 150K, 250K" required>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="fitur_available[]" value="1" checked>
